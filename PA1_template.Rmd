...
The daily mean number of steps is `r daily_mean` and the median number of stepes is `r daily_median`.
...
The interval with the largest average number of steps (with `r max_steps` steps) is `r max_interval`.
...
The number of observations with missing values is `r num_nas`.
